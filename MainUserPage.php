...
<head>
    <meta charset="utf-8">
    <title>User - Out Of Office</title>
...
<body class="bodyBackground fontFormat fw-bold">
    <div class="row d-flex justify-content-center m-0">
        <a href="ListRequests.php" class="adminPageContainer rounded col-4">
            <h1 class="text-center text-uppercase">
                Szabadságaim
            </h1>
        </a>

        <a href="CreateRequest.php" class="adminPageContainer rounded col-4">
            <h1 class="text-center text-uppercase">
                Szabadság
            </h1>
            <h1 class="text-center text-uppercase">
